package com.audible.paymentMS.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
		...
		System.out.println("ResourceNotFoundException handled globally in payment service");
	...
	public ResponseEntity<Object> handleIllegalArgumentException(IllegalArgumentException ex, WebRequest request) {
	    ...
	    System.out.println("IllegalArgumentException handled globally in payment service");
	...
	public ResponseEntity<Object> handleRuntimeException(RuntimeException ex, WebRequest request) {
	    ...
	    System.out.println("RuntimeException handled globally in payment service");

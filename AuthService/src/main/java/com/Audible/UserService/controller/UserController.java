...
public class UserController {
    ...
    /**
     * POST /user/cart/add/{userId}
     * Adds audiobooks to the user's cart. If cart doesn't exist, creates one.
     */
    ...
    /**
     * GET /user/cart/get/{userId}
     * Returns list of audiobooks in the user's cart.
     */
    ...
    /**
     * DELETE /user/cart/remove/{userId}/{audiobookId}
